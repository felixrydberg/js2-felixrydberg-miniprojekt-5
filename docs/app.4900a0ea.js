 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ln{constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/an,10)),this.current_=this.count-1;const n=(i=this.count,parseInt(Array(i+1).join("1"),2));var i;this.bits_=e+1&n}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const hn=function(e,t,n,i){e.sort(t);const s=function(t,i){const r=i-t;let o,a;if(0===r)return null;if(1===r)return o=e[t],a=n?n(o):o,new Gt(a,o.node,Gt.BLACK,null,null);{const l=parseInt(r/2,10)+t,h=s(t,l),c=s(l+1,i);return o=e[l],a=n?n(o):o,new Gt(a,o.node,Gt.BLACK,h,c)}},r=function(t){let i=null,r=null,o=e.length;const a=function(t,i){const r=o-t,a=o;o-=t;const h=s(r+1,a),c=e[r],u=n?n(c):c;l(new Gt(u,c.node,i,null,h))},l=function(e){i?(i.left=e,i=e):(r=e,i=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),i=Math.pow(2,t.count-(e+1));n?a(i,Gt.BLACK):(a(i,Gt.BLACK),a(i,Gt.RED))}return r}(new ln(e.length));return new Kt(i||t,r)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cn;const un={};class dn{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return i(un&&on,"ChildrenNode.ts has not been loaded"),cn=cn||new dn({".priority":un},{".priority":on}),cn}get(e){const t=E(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Kt?t:null}hasIndex(e){return b(this.indexSet_,e.toString())}addIndex(e,t){i(e!==$t,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let s=!1;const r=t.getIterator(jt.Wrap);let o,a=r.getNext();for(;a;)s=s||e.isDefinedOn(a.node),n.push(a),a=r.getNext();o=s?hn(n,e.getCompare()):un;const l=e.toString(),h=Object.assign({},this.indexSet_);h[l]=e;const c=Object.assign({},this.indexes_);return c[l]=o,new dn(c,h)}addToIndexes(e,t){const n=I(this.indexes_,((n,s)=>{const r=E(this.indexSet_,s);if(i(r,"Missing index implementation for "+s),n===un){if(r.isDefinedOn(e.node)){const n=[],i=t.getIterator(jt.Wrap);let s=i.getNext();for(;s;)s.name!==e.name&&n.push(s),s=i.getNext();return n.push(e),hn(n,r.getCompare())}return un}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new jt(e.name,i))),s.insert(e,e.node)}}));return new dn(n,this.indexSet_)}removeFromIndexes(e,t){const n=I(this.indexes_,(n=>{if(n===un)return n;{const i=t.get(e.name);return i?n.remove(new jt(e.name,i)):n}}));return new dn(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Cn(e){return{type:"value",snapshotNode:e}}function wn(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function bn(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function En(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Tn{constructor(e){this.index_=e}updateChild(e,t,n,s,r,o){i(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(n.getChild(s))&&a.isEmpty()===n.isEmpty()?e:(null!=o&&(n.isEmpty()?e.hasChild(t)?o.trackChildChange(bn(t,a)):i(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(wn(t,n)):o.trackChildChange(En(t,n,a))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(on,((e,i)=>{t.hasChild(e)||n.trackChildChange(bn(e,i))})),t.isLeafNode()||t.forEachChild(on,((t,i)=>{if(e.hasChild(t)){const s=e.getImmediateChild(t);s.equals(i)||n.trackChildChange(En(t,i,s))}else n.trackChildChange(wn(t,i))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?_n.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xn extends wt{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=je("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(i(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=xn.getListenId_(e,n),o={};this.listens_[r]=o;const a=Nn(e._queryParams);this.restRequest_(s+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(s,a,!1,n),E(this.listens_,r)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=xn.getListenId_(e,t);delete this.listens_[n]}get(e){const t=Nn(e._queryParams),n=e._path.toString(),i=new d;return this.restRequest_(n+".json",t,((e,t)=>{let s=t;404===e&&(s=null,e=null),null===e?(this.onDataUpdate_(n,s,!1,null),i.resolve(s)):i.reject(new Error(s))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+function(e){const t=[];for(const[n,i]of Object.entries(e))Array.isArray(i)?i.forEach((e=>{t.push(encodeURIComponent(n)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(n)+"="+encodeURIComponent(i));return t.length?"&"+t.join("&"):""}(t);this.log_("Sending REST request for "+r);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+r+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=v(o.responseText)}catch(e){Ve("Failed to parse JSON response for "+r+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&Ve("Got unsuccessful REST response for "+r+" Status: "+o.status),n(o.status);n=null}},o.open("GET",r,!0),o.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{Mn(i,new Tt(t.toString()+"/"+e),n)}))}class On{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Je(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hn{constructor(e,t){this.source=e,this.path=t,this.type=Fn.LISTEN_COMPLETE}operationForChild(e){return At(this.path)?new Hn(this.source,It()):new Hn(this.source,Nt(this.path))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Fn.OVERWRITE}operationForChild(e){return At(this.path)?new jn(this.source,It(),this.snap.getImmediateChild(e)):new jn(this.source,Nt(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Fn.MERGE}operationForChild(e){if(At(this.path)){const t=this.children.subtree(new Tt(e));return t.isEmpty()?null:t.value?new jn(this.source,It(),t.value):new Bn(this.source,It(),t)}return i(St(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Bn(this.source,Nt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ui(e,t){return Ti(t,e)}function di(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));i(n>=0,"removeWrite called with nonexistent writeId.");const s=e.allWrites[n];e.allWrites.splice(n,1);let r=s.visible,o=!1,a=e.allWrites.length-1;for(;r&&a>=0;){const t=e.allWrites[a];t.visible&&(a>=n&&pi(t,s.path)?r=!1:Lt(s.path,t.path)&&(o=!0)),a--}if(r){if(o)return function(e){e.visibleWrites=fi(e.allWrites,_i,It()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(s.snap)e.visibleWrites=ii(e.visibleWrites,s.path);else{Je(s.children,(t=>{e.visibleWrites=ii(e.visibleWrites,Dt(s.path,t))}))}return!0}return!1}function pi(e,t){if(e.snap)return Lt(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&Lt(Dt(e.path,n),t))return!0;return!1}function _i(e){return e.visible}function fi(e,t,n){let i=ei.empty();for(let r=0;r<e.length;++r){const o=e[r];if(t(o)){const e=o.path;let t;if(o.snap)Lt(n,e)?(t=Mt(n,e),i=ti(i,t,o.snap)):Lt(e,n)&&(t=Mt(e,n),i=ti(i,It(),o.snap.getChild(t)));else{if(!o.children)throw s("WriteRecord should have .snap or .children");if(Lt(n,e))t=Mt(n,e),i=ni(i,t,o.children);else if(Lt(e,n))if(t=Mt(e,n),At(t))i=ni(i,It(),o.children);else{const e=E(o.children,St(t));if(e){const n=e.getChild(Nt(t));i=ti(i,It(),n)}}}}}return i}function gi(e,t,n,i,s){if(i||s){const r=ai(e.visibleWrites,t);if(!s&&li(r))return n;if(s||null!=n||si(r,It())){const r=function(e){return(e.visible||s)&&(!i||!~i.indexOf(e.writeId))&&(Lt(e.path,t)||Lt(t,e.path))};return hi(fi(e.allWrites,r,t),n||_n.EMPTY_NODE)}return null}{const i=ri(e.visibleWrites,t);if(null!=i)return i;{const i=ai(e.visibleWrites,t);if(li(i))return n;if(null!=n||si(i,It())){return hi(i,n||_n.EMPTY_NODE)}return null}}}function mi(e,t,n,i){return gi(e.writeTree,e.treePath,t,n,i)}function yi(e,t){return function(e,t,n){let i=_n.EMPTY_NODE;const s=ri(e.visibleWrites,t);if(s)return s.isLeafNode()||s.forEachChild(on,((e,t)=>{i=i.updateImmediateChild(e,t)})),i;if(n){const s=ai(e.visibleWrites,t);return n.forEachChild(on,((e,t)=>{const n=hi(ai(s,new Tt(e)),t);i=i.updateImmediateChild(e,n)})),oi(s).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}return oi(ai(e.visibleWrites,t)).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}(e.writeTree,e.treePath,t)}function vi(e,t,n,s){return function(e,t,n,s,r){i(s||r,"Either existingEventSnap or existingServerSnap must exist");const o=Dt(t,n);if(si(e.visibleWrites,o))return null;{const t=ai(e.visibleWrites,o);return li(t)?r.getChild(n):hi(t,r.getChild(n))}}(e.writeTree,e.treePath,t,n,s)}function Ci(e,t){return function(e,t){return ri(e.visibleWrites,t)}(e.writeTree,Dt(e.treePath,t))}function wi(e,t,n,i,s,r){return function(e,t,n,i,s,r,o){let a;const l=ai(e.visibleWrites,t),h=ri(l,It());if(null!=h)a=h;else{if(null==n)return[];a=hi(l,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let l=n.getNext();for(;l&&e.length<s;)0!==t(l,i)&&e.push(l),l=n.getNext();return e}}(e.writeTree,e.treePath,t,n,i,s,r)}function bi(e,t,n){return function(e,t,n,i){const s=Dt(t,n),r=ri(e.visibleWrites,s);if(null!=r)return r;if(i.isCompleteForChild(n))return hi(ai(e.visibleWrites,s),i.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function Ei(e,t){return Ti(Dt(e.treePath,t),e.writeTree)}function Ti(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ni(e,t,n,r,o){const a=new Ii;let l,h;if(n.type===Fn.OVERWRITE){const s=n;s.source.fromUser?l=Ri(e,t,s.path,s.snap,r,o,a):(i(s.source.fromServer,"Unknown source."),h=s.source.tagged||t.serverCache.isFiltered()&&!At(s.path),l=xi(e,t,s.path,s.snap,r,o,h,a))}else if(n.type===Fn.MERGE){const s=n;s.source.fromUser?l=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const h=Dt(n,i);Di(t,St(h))&&(a=Ri(e,a,h,l,s,r,o))})),i.foreach(((i,l)=>{const h=Dt(n,i);Di(t,St(h))||(a=Ri(e,a,h,l,s,r,o))})),a}(e,t,s.path,s.children,r,o,a):(i(s.source.fromServer,"Unknown source."),h=s.source.tagged||t.serverCache.isFiltered(),l=Mi(e,t,s.path,s.children,r,o,h,a))}else if(n.type===Fn.ACK_USER_WRITE){const s=n;l=s.revert?function(e,t,n,s,r,o){let a;if(null!=Ci(s,n))return t;{const l=new ki(s,t,r),h=t.eventCache.getNode();let c;if(At(n)||".priority"===St(n)){let n;if(t.serverCache.isFullyInitialized())n=mi(s,Xn(t));else{const e=t.serverCache.getNode();i(e instanceof _n,"serverChildren would be complete if leaf node"),n=yi(s,e)}c=e.filter.updateFullNode(h,n,o)}else{const i=St(n);let r=bi(s,i,t.serverCache);null==r&&t.serverCache.isCompleteForChild(i)&&(r=h.getImmediateChild(i)),c=null!=r?e.filter.updateChild(h,i,r,Nt(n),l,o):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(h,i,_n.EMPTY_NODE,Nt(n),l,o):h,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=mi(s,Xn(t)),a.isLeafNode()&&(c=e.filter.updateFullNode(c,a,o)))}return a=t.serverCache.isFullyInitialized()||null!=Ci(s,It()),Gn(t,c,a,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,s.path,r,o,a):function(e,t,n,i,s,r,o){if(null!=Ci(s,n))return t;const a=t.serverCache.isFiltered(),l=t.serverCache;if(null!=i.value){if(At(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return xi(e,t,n,l.getNode().getChild(n),s,r,a,o);if(At(n)){let i=new Zn(null);return l.getNode().forEachChild($t,((e,t)=>{i=i.set(new Tt(e),t)})),Mi(e,t,n,i,s,r,a,o)}return t}{let h=new Zn(null);return i.foreach(((e,t)=>{const i=Dt(n,e);l.isCompleteForPath(i)&&(h=h.set(e,l.getNode().getChild(i)))})),Mi(e,t,n,h,s,r,a,o)}}(e,t,s.path,s.affectedTree,r,o,a)}else{if(n.type!==Fn.LISTEN_COMPLETE)throw s("Unknown operation type: "+n.type);l=function(e,t,n,i,s){const r=t.serverCache,o=Kn(t,r.getNode(),r.isFullyInitialized()||At(n),r.isFiltered());return Pi(e,o,n,i,Si,s)}(e,t,n.path,r,a)}const c=a.getChanges();return function(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=Qn(e);(n.length>0||!e.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(Cn(Qn(t)))}}(t,l,c),{viewCache:l,changes:c}}function Pi(e,t,n,s,r,o){const a=t.eventCache;if(null!=Ci(s,n))return t;{let l,h;if(At(n))if(i(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=Xn(t),i=yi(s,n instanceof _n?n:_n.EMPTY_NODE);l=e.filter.updateFullNode(t.eventCache.getNode(),i,o)}else{const n=mi(s,Xn(t));l=e.filter.updateFullNode(t.eventCache.getNode(),n,o)}else{const c=St(n);if(".priority"===c){i(1===kt(n),"Can't have a priority with additional path components");const r=a.getNode();h=t.serverCache.getNode();const o=vi(s,n,r,h);l=null!=o?e.filter.updatePriority(r,o):a.getNode()}else{const i=Nt(n);let u;if(a.isCompleteForChild(c)){h=t.serverCache.getNode();const e=vi(s,n,a.getNode(),h);u=null!=e?a.getNode().getImmediateChild(c).updateChild(i,e):a.getNode().getImmediateChild(c)}else u=bi(s,c,t.serverCache);l=null!=u?e.filter.updateChild(a.getNode(),c,u,i,r,o):a.getNode()}}return Gn(t,l,a.isFullyInitialized()||At(n),e.filter.filtersNodes())}}function xi(e,t,n,i,s,r,o,a){const l=t.serverCache;let h;const c=o?e.filter:e.filter.getIndexedFilter();if(At(n))h=c.updateFullNode(l.getNode(),i,null);else if(c.filtersNodes()&&!l.isFiltered()){const e=l.getNode().updateChild(n,i);h=c.updateFullNode(l.getNode(),e,null)}else{const e=St(n);if(!l.isCompleteForPath(n)&&kt(n)>1)return t;const s=Nt(n),r=l.getNode().getImmediateChild(e).updateChild(s,i);h=".priority"===e?c.updatePriority(l.getNode(),r):c.updateChild(l.getNode(),e,r,s,Si,null)}const u=Kn(t,h,l.isFullyInitialized()||At(n),c.filtersNodes());return Pi(e,u,n,s,new ki(s,u,r),a)}function Ri(e,t,n,i,s,r,o){const a=t.eventCache;let l,h;const c=new ki(s,t,r);if(At(n))h=e.filter.updateFullNode(t.eventCache.getNode(),i,o),l=Gn(t,h,!0,e.filter.filtersNodes());else{const s=St(n);if(".priority"===s)h=e.filter.updatePriority(t.eventCache.getNode(),i),l=Gn(t,h,a.isFullyInitialized(),a.isFiltered());else{const r=Nt(n),h=a.getNode().getImmediateChild(s);let u;if(At(r))u=i;else{const e=c.getCompleteChild(s);u=null!=e?".priority"===Pt(r)&&e.getChild(Rt(r)).isEmpty()?e:e.updateChild(r,i):_n.EMPTY_NODE}if(h.equals(u))l=t;else{l=Gn(t,e.filter.updateChild(a.getNode(),s,u,r,c,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return l}function Di(e,t){return e.eventCache.isCompleteForChild(t)}function Ai(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function Mi(e,t,n,i,s,r,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let l,h=t;l=At(n)?i:new Zn(null).setTree(n,i);const c=t.serverCache.getNode();return l.children.inorderTraversal(((n,i)=>{if(c.hasChild(n)){const l=Ai(0,t.serverCache.getNode().getImmediateChild(n),i);h=xi(e,h,new Tt(n),l,s,r,o,a)}})),l.children.inorderTraversal(((n,i)=>{const l=!t.serverCache.isCompleteForChild(n)&&void 0===i.value;if(!c.hasChild(n)&&!l){const l=Ai(0,t.serverCache.getNode().getImmediateChild(n),i);h=xi(e,h,new Tt(n),l,s,r,o,a)}})),h}class Oi{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,i=new Tn(n.getIndex()),s=(r=n).loadsAllData()?new Tn(r.getIndex()):r.hasLimit()?new Sn(r):new In(r);var r;this.processor_=function(e){return{filter:e}}(s);const o=t.serverCache,a=t.eventCache,l=i.updateFullNode(_n.EMPTY_NODE,o.getNode(),null),h=s.updateFullNode(_n.EMPTY_NODE,a.getNode(),null),c=new zn(l,o.isFullyInitialized(),i.filtersNodes()),u=new zn(h,a.isFullyInitialized(),s.filtersNodes());this.viewCache_=Yn(u,c),this.eventGenerator_=new Vn(this.query_)}get query(){return this.query_}}function Li(e,t){const n=Xn(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!At(t)&&!n.getImmediateChild(St(t)).isEmpty())?n.getChild(t):null}function Fi(e){return 0===e.eventRegistrations_.length}function qi(e,t,n){const s=[];if(n){i(null==t,"A cancel should cancel all event registrations.");const r=e.query._path;e.eventRegistrations_.forEach((e=>{const t=e.createCancelEvent(n,r);t&&s.push(t)}))}if(t){let n=[];for(let i=0;i<e.eventRegistrations_.length;++i){const s=e.eventRegistrations_[i];if(s.matches(t)){if(t.hasAnyCallback()){n=n.concat(e.eventRegistrations_.slice(i+1));break}}else n.push(s)}e.eventRegistrations_=n}else e.eventRegistrations_=[];return s}function Ui(e,t,n,s){t.type===Fn.MERGE&&null!==t.source.queryId&&(i(Xn(e.viewCache_),"We should always have a full cache before handling merges"),i(Qn(e.viewCache_),"Missing event cache, even though we have a server cache"));const r=e.viewCache_,o=Ni(e.processor_,r,t,n,s);var a,l;return a=e.processor_,l=o.viewCache,i(l.eventCache.getNode().isIndexed(a.filter.getIndex()),"Event snap not indexed"),i(l.serverCache.getNode().isIndexed(a.filter.getIndex()),"Server snap not indexed"),i(o.viewCache.serverCache.isFullyInitialized()||!r.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=o.viewCache,Wi(e,o.changes,o.viewCache.eventCache.getNode(),null)}function Wi(e,t,n,i){const s=i?[i]:e.eventRegistrations_;return function(e,t,n,i){const s=[],r=[];return t.forEach((t=>{var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&r.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),$n(e,s,"child_removed",t,i,n),$n(e,s,"child_added",t,i,n),$n(e,s,"child_moved",r,i,n),$n(e,s,"child_changed",t,i,n),$n(e,s,"value",t,i,n),s}(e.eventGenerator_,t,n,s)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let es=1;class ts{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Zn(null),this.pendingWriteTree_={visibleWrites:ei.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ns(e,t,n,s,r){return function(e,t,n,s,r){i(s>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:s,visible:r}),r&&(e.visibleWrites=ti(e.visibleWrites,t,n)),e.lastWriteId=s}(e.pendingWriteTree_,t,n,s,r),r?ls(e,new jn({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function is(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(di(e.pendingWriteTree_,t)){let t=new Zn(null);return null!=i.snap?t=t.set(It(),!0):Je(i.children,(e=>{t=t.set(new Tt(e),!0)})),ls(e,new Wn(i.path,t,n))}return[]}function ss(e,t,n){return ls(e,new jn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function rs(e,t,n,i){const s=t._path,r=e.syncPointTree_.get(s);let o=[];if(r&&("default"===t._queryIdentifier||Xi(r,t))){const a=Yi(r,t,n,i);0===r.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const l=a.removed;o=a.events;const h=-1!==l.findIndex((e=>e._queryParams.loadsAllData())),c=e.syncPointTree_.findOnPath(s,((e,t)=>Ji(t)));if(h&&!c){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&Ji(t)){return[Zi(t)]}{let e=[];return t&&(e=Gi(t)),Je(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],s=i.query,r=us(e,i);e.listenProvider_.startListening(ms(s),ds(e,s),r.hashFn,r.onComplete)}}}if(!c&&l.length>0&&!i)if(h){const n=null;e.listenProvider_.stopListening(ms(t),n)}else l.forEach((t=>{const n=e.queryToTagMap.get(ps(t));e.listenProvider_.stopListening(ms(t),n)}));!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=ps(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,l)}return o}function os(e,t,n){const s=t._path;let r=null,o=!1;e.syncPointTree_.foreachOnPath(s,((e,t)=>{const n=Mt(e,s);r=r||Ki(t,n),o=o||Ji(t)}));let a,l=e.syncPointTree_.get(s);if(l?(o=o||Ji(l),r=r||Ki(l,It())):(l=new Bi,e.syncPointTree_=e.syncPointTree_.set(s,l)),null!=r)a=!0;else{a=!1,r=_n.EMPTY_NODE;e.syncPointTree_.subtree(s).foreachChild(((e,t)=>{const n=Ki(t,It());n&&(r=r.updateImmediateChild(e,n))}))}const h=Xi(l,t);if(!h&&!t._queryParams.loadsAllData()){const n=ps(t);i(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const s=es++;e.queryToTagMap.set(n,s),e.tagToQueryMap.set(s,n)}let c=$i(l,t,n,ui(e.pendingWriteTree_,s),r,a);if(!h&&!o){const n=Qi(l,t);c=c.concat(function(e,t,n){const s=t._path,r=ds(e,t),o=us(e,n),a=e.listenProvider_.startListening(ms(t),r,o.hashFn,o.onComplete),l=e.syncPointTree_.subtree(s);if(r)i(!Ji(l.value),"If we're adding a query, it shouldn't be shadowed");else{const t=l.fold(((e,t,n)=>{if(!At(e)&&t&&Ji(t))return[Zi(t).query];{let e=[];return t&&(e=e.concat(Gi(t).map((e=>e.query)))),Je(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(ms(i),ds(e,i))}}return a}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return c}function as(e,t,n){const i=e.pendingWriteTree_,s=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Ki(n,Mt(e,t));if(i)return i}));return gi(i,t,s,n,!0)}function ls(e,t){return hs(t,e.syncPointTree_,null,ui(e.pendingWriteTree_,It()))}function hs(e,t,n,i){if(At(e.path))return cs(e,t,n,i);{const s=t.get(It());null==n&&null!=s&&(n=Ki(s,It()));let r=[];const o=St(e.path),a=e.operationForChild(o),l=t.children.get(o);if(l&&a){const e=n?n.getImmediateChild(o):null,t=Ei(i,o);r=r.concat(hs(a,l,e,t))}return s&&(r=r.concat(zi(s,e,i,n))),r}}function cs(e,t,n,i){const s=t.get(It());null==n&&null!=s&&(n=Ki(s,It()));let r=[];return t.children.inorderTraversal(((t,s)=>{const o=n?n.getImmediateChild(t):null,a=Ei(i,t),l=e.operationForChild(t);l&&(r=r.concat(cs(l,s,o,a)))})),s&&(r=r.concat(zi(s,e,i,n))),r}function us(e,t){const n=t.query,i=ds(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||_n.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return i?function(e,t,n){const i=_s(e,n);if(i){const n=fs(i),s=n.path,r=n.queryId,o=Mt(s,t);return gs(e,s,new Hn(Un(r),o))}return[]}(e,n._path,i):function(e,t){return ls(e,new Hn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return rs(e,n,null,i)}}}}function ds(e,t){const n=ps(t);return e.queryToTagMap.get(n)}function ps(e){return e._path.toString()+"$"+e._queryIdentifier}function _s(e,t){return e.tagToQueryMap.get(t)}function fs(e){const t=e.indexOf("$");return i(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Tt(e.substr(0,t))}}function gs(e,t,n){const s=e.syncPointTree_.get(t);i(s,"Missing sync point for query tag that we're tracking");return zi(s,n,ui(e.pendingWriteTree_,t),null)}function ms(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(i(ji,"Reference.ts has not been loaded"),ji)(e._repo,e._path):e}class ys{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ys(t)}node(){return this.node_}}class vs{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=Dt(this.path_,e);return new vs(this.syncTree_,t)}node(){return as(this.syncTree_,this.path_)}}const Cs=function(e,t,n){return e&&"object"==typeof e?(i(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?ws(e[".sv"],t,n):"object"==typeof e[".sv"]?bs(e[".sv"],t):void i(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},ws=function(e,t,n){if("timestamp"===e)return n.timestamp;i(!1,"Unexpected server value: "+e)},bs=function(e,t,n){e.hasOwnProperty("increment")||i(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const s=e.increment;"number"!=typeof s&&i(!1,"Unexpected increment value: "+s);const r=t.node();if(i(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return s;const o=r.getValue();return"number"!=typeof o?s:o+s},Es=function(e,t,n,i){return Is(t,new vs(n,e),i)},Ts=function(e,t,n){return Is(e,new ys(t),n)};function Is(e,t,n){const i=e.getPriority().val(),s=Cs(i,t.getImmediateChild(".priority"),n);let r;if(e.isLeafNode()){const i=e,r=Cs(i.getValue(),t,n);return r!==i.getValue()||s!==i.getPriority().val()?new rn(r,gn(s)):e}{const i=e;return r=i,s!==i.getPriority().val()&&(r=r.updatePriority(new rn(s))),i.forEachChild(on,((e,i)=>{const s=Is(i,t.getImmediateChild(e),n);s!==i&&(r=r.updateImmediateChild(e,s))})),r}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Er{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return At(this._path)?null:Pt(this._path)}get ref(){return new Tr(this._repo,this._path)}get _queryIdentifier(){const e=Pn(this._queryParams),t=Qe(e);return"{}"===t?"default":t}get _queryObject(){return Pn(this._queryParams)}isEqual(e){if(!((e=R(e))instanceof Er))return!1;const t=this._repo===e._repo,n=Ot(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class Tr extends Er{constructor(e,t){super(e,t,new kn,!1)}get parent(){const e=Rt(this._path);return null===e?null:new Tr(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class Ir{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Tt(e),n=kr(this.ref,e);return new Ir(this._node.getChild(t),n,on)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Ir(n,kr(this.ref,t),on))))}hasChild(e){const t=new Tt(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Sr(e,t){return(e=R(e))._checkNotDeleted("ref"),void 0!==t?kr(e._root,t):e._root}function kr(e,t){var n,i,s,r;return null===St((e=R(e))._path)?(n="child",i="path",r=!1,(s=t)&&(s=s.replace(/^\/*\.info(\/|$)/,"/")),Hs(n,i,s,r)):Hs("child","path",t,!1),new Tr(e._repo,Dt(e._path,t))}function Nr(e,t){e=R(e),js("set",e._path),Us("set",t,e._path,!1);const n=new d;return sr(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}class Pr{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new Cr("value",this,new Ir(e.snapshotNode,new Tr(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new wr(this,e,t):null}matches(e){return e instanceof Pr&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class xr{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new wr(this,e,t):null}createEvent(e,t){i(null!=e.childName,"Child events should have a childName.");const n=kr(new Tr(t._repo,t._path),e.childName),s=t._queryParams.getIndex();return new Cr(e.type,this,new Ir(e.snapshotNode,n,s),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof xr&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function Rr(e,t,n,i,s){let r;if("object"==typeof i&&(r=void 0,s=i),"function"==typeof i&&(r=i),s&&s.onlyOnce){const t=n,i=(n,i)=>{rr(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const o=new br(n,r||void 0),a="value"===t?new Pr(o):new xr(t,o);return function(e,t,n){let i;i=".info"===St(t._path)?os(e.infoSyncTree_,t,n):os(e.serverSyncTree_,t,n),$s(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>rr(e._repo,e,a)}function Dr(e,t,n,i){return Rr(e,"value",t,n,i)}!function(e){i(!Hi,"__referenceConstructor has already been defined"),Hi=e}(Tr),function(e){i(!ji,"__referenceConstructor has already been defined"),ji=e}(Tr);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ar={};let Mr=!1;function Or(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||ze("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),He("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=yr(r,s),h=l.repoInfo;void 0!==pe&&(a=pe.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,r=`http://${a}?ns=${h.namespace}`,l=yr(r,s),h=l.repoInfo):o=!l.repoInfo.secure;const c=s&&o?new ot(ot.OWNER):new rt(e.name,e.options,t);Bs("Invalid Firebase Database URL",l),At(l.path)||ze("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let s=Ar[t.name];s||(s={},Ar[t.name]=s);let r=s[e.toURLString()];r&&ze("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new Qs(e,Mr,n,i),s[e.toURLString()]=r,r}(h,e,c,new st(e.name,n));return new Lr(u,e)}class Lr{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Xs(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Tr(this._repo,It())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Ar[t];n&&n[e.key]===e||ze(`Database ${t}(${e.repoInfo_}) has already been deleted.`),or(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&ze("Cannot call "+e+" on a deleted database.")}}Ht.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Ht.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const Fr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new U(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyAPk8Givpk9frARWezj0S24X51vutsyTXc",authDomain:"chat-fec7d.firebaseapp.com",databaseURL:"https://chat-fec7d-default-rtdb.europe-west1.firebasedatabase.app",projectId:"chat-fec7d",storageBucket:"chat-fec7d.appspot.com",messagingSenderId:"505237520486",appId:"1:505237520486:web:c93fd68ca9ab79e7e22da7"}));class qr{messages=[];addMessage(e){this.messages.push(e)}removeField(e){this.messages.splice(e,1)}clear(){this.messages=[]}reverse(){this.messages.reverse()}editMessage(e,t){this.messages[e]=t}}!function(){localStorage.getItem("name")||(window.location.href="../"),document.querySelector("header nav ul li a").addEventListener("click",(()=>{localStorage.clear()})),function(){const t=new qr;document.querySelector(".msg-form").addEventListener("submit",(e=>{e.preventDefault(),n(t)})),Dr(Sr(Fr),(n=>{let i=n.val();t.clear();for(const e in i)t.addMessage(i[e]);t.reverse(),e(t)}))}();const e=e=>{const n=document.querySelector(".article-msg");for(;n.firstChild;)n.lastChild.remove();for(const n in e.messages)t(e,e.messages[n],n)},t=(e,t,n)=>{const r=document.querySelector(".article-msg");let o=new Date(t.date).getFullYear(),a=new Date(t.date).getMonth();const l=document.createElement("article");l.classList.add(n);const h=document.createElement("p");h.classList.add("msg-name"),h.innerText=`${t.name}`;const c=document.createElement("p");c.classList.add("msg-content"),c.innerText=`${t.content}`;const u=document.createElement("p");if(u.classList.add("msg-date"),u.innerText=`${o}/${["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][a]}`,l.appendChild(h),l.appendChild(u),l.appendChild(c),localStorage.getItem("name")===t.name){const t=document.createElement("figure");t.classList.add("msg-btn-container");const r=document.createElement("button");r.innerText="Edit",r.addEventListener("click",(()=>{s(n,e,r.parentNode.parentNode)})),t.appendChild(r);const o=document.createElement("button");o.innerText="x",o.addEventListener("click",(()=>{i(n,e)})),t.appendChild(o),l.appendChild(t)}r.appendChild(l)},n=e=>{const t=document.querySelector(".form-content"),n=localStorage.getItem("name"),i=document.querySelector(".form-type");e.reverse(),e.addMessage({content:t.value,date:Date.now(),name:n,type:i.value});for(let t=0;t<e.messages.length;t++)t>=25&&e.removeField(0);Nr(Sr(Fr),e.messages)},i=(e,t)=>{t.removeField(e),t.reverse(),Nr(Sr(Fr),t.messages)},s=(e,t,n)=>{const i=document.createElement("form"),s=document.createElement("input");s.classList.add("msg-edit"),s.setAttribute("type","text"),s.setAttribute("requried","null");const o=document.createElement("input");o.setAttribute("type","submit"),o.setAttribute("value","Edit"),i.appendChild(s),i.appendChild(o),i.addEventListener("submit",(n=>{n.preventDefault();const i={content:s.value,date:t.messages[e].date,name:t.messages[e].name,type:t.messages[e].type};t.editMessage(e,i),r(t)})),n.appendChild(i)},r=e=>{e.reverse(),console.log(e.messages),Nr(Sr(Fr),e.messages)}}();
//# sourceMappingURL=app.4900a0ea.js.map
